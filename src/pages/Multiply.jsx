...
const p = pillars.find((x) => x.key === 'multiply')
const next = pillars[pillars.findIndex((x) => x.key === 'multiply') + 1]

const capabilities = [
  { icon: Tv, img: '/img/mul-ott.jpeg', title: 'OTT Platforms', desc: 'Stream your content on ELamp’s owned media properties and OTT platforms.' },
  { icon: Handshake, img: '/img/mul-partners.jpeg', title: 'Partner Networks', desc: 'Distribute through an established web of media and industry partners.' },
  { icon: Share2, img: '/img/mul-social.jpeg', title: 'Social Platforms', desc: 'Native publishing across every major social platform, optimized per channel.' },
  { icon: Globe, img: '/img/mul-global.jpeg', title: 'Global Reach', desc: 'Reach audiences worldwide with localized, region-ready distribution.' },
  { icon: Users, img: '/img/mul-creators.jpeg', title: 'Creator Distribution', desc: 'Creators re-share and spread your content to their communities.' },
  { icon: Network, img: '/img/mul-channels.jpeg', title: 'Distribution Channels', desc: 'A multiplying web of channels that carries your content everywhere it belongs.' },
]

const steps = [
  { n: '01', icon: Package, title: 'Package', desc: 'Format and version your content for every channel.' },
  { n: '02', icon: Tv, title: 'Place', desc: 'Launch across OTT, partners and social platforms.' },
  { n: '03', icon: Languages, title: 'Localize', desc: 'Adapt for languages and regions to travel further.' },
  { n: '04', icon: Users, title: 'Spread', desc: 'Activate creators and networks to multiply reach.' },
  { n: '05', icon: Rocket, title: 'Scale', desc: 'Expand distribution behind whatever performs.' },
]

const deliverables = [
  'OTT & platform placement',
  'Partner distribution',
  'Multi-platform publishing',
  'Localization & dubbing',
  'Creator seeding',
  'Reach & audience analytics',
]

const audience = ['Filmmakers', 'Studios', 'Brands', 'Creators', 'Distributors']
          ...
          <div className="grid items-center gap-10 md:grid-cols-2 md:gap-16">
            ...
            >
              ...
              <h1 className="font-display mt-7 text-4xl font-extrabold leading-[1.03] text-white sm:text-6xl">
                Distribute <br className="hidden sm:block" />
                <span className="text-gradient">everywhere.</span>
              </h1>

              <p className="mt-6 max-w-xl text-lg text-fog">
                ELamp’s owned media properties, partner networks, social platforms,
                creators and other distribution channels multiply the audience for
                your content.
              </p>

              <p className="font-display mt-5 text-2xl font-bold">
                <span className="text-gradient">Multiply your audience.</span>
              </p>
      ...
      <section className="relative py-14 md:py-20">
        ...
        <div className="w-full px-[10px]">
          <Reveal className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="font-display mt-3 text-4xl font-extrabold text-white md:text-5xl">
              From one channel to all of them
            </h2>
          </Reveal>
          ...
          <div className="mx-auto grid max-w-6xl gap-10 md:grid-cols-2 md:gap-16">
            ...
            <Reveal delay={0.1}>
              ...
              <p className="mt-6 max-w-md text-fog">
                Your content deserves the biggest possible audience. Multiply puts it
                everywhere the right people already are.
              </p>
            </Reveal>
          </div>
        </div>
          ...
          <Reveal className="relative mx-auto max-w-4xl overflow-hidden rounded-[32px] border border-white/10 p-1">
            ...
            <div className="rounded-[28px] bg-ink-2/80 p-8 text-center backdrop-blur-xl md:p-14">
              <h2 className="font-display text-3xl font-extrabold leading-tight text-white md:text-5xl">
                Ready to <span className="text-gradient">multiply your audience?</span>
              </h2>
              <p className="mx-auto mt-4 max-w-xl text-fog">
                Let’s get your content in front of the world.
              </p>
